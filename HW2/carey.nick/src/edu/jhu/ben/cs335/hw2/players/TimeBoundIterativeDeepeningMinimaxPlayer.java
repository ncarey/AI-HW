...
public class TimeBoundIterativeDeepeningMinimaxPlayer extends Player {
   ...
   */
  public TimeBoundIterativeDeepeningMinimaxPlayer(double timeBound, int playerColor) {
  ...
  /**
   * Method that returns the player's next move according to the time bound Minimax Search Algorithm 
